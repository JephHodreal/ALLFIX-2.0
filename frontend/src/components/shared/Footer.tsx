        ...
        <Grid component="div" container spacing={{ xs: 4, sm: 6, lg: 8, xl: 10 }} sx={{ justifyContent: 'space-between' }}>
          ...
          <Grid size={{ xs: 12, sm: 4, lg: 2 }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
              ...
              <Typography onClick={() => { navigate('/vendor-apply'); window.scrollTo(0, 0); }} sx={{ color: 'rgba(255,255,255,0.9)', fontSize: '1.05rem', cursor: 'pointer', transition: 'color 0.2s', '&:hover': { color: 'white' } }}>Become a Partner</Typography>
            </Box>
          </Grid>
