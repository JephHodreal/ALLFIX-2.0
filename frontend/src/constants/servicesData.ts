...
export const servicesData: ServiceBrand[] = [
  {
    ...
    description: 'Core category for all air-conditioning maintenance, repair, and installation services. Manages HVAC-certified vendors.',
  ...
  },
  {
    ...
    description: 'Operational category for professional deep cleaning, sanitation, and hygiene services. Oversees sanitation-certified vendors.',
  ...
  },
  {
    ...
    description: 'Central hub for civil works, plumbing, and electrical services. Coordinates contractors for home and office structural maintenance.',
  ...
  },
  {
    ...
    description: 'Logistics and transportation category managing relocation requests. Facilitates coordination with licensed moving and packing vendors.',
  ...
  },
  {
    ...
    description: 'Environmental services category managing sustainable waste disposal and eco-friendly solutions. Oversees green-certified partners.',
  ...
  },
  {
    ...
    description: 'Medical and wellness category facilitating home-based healthcare requests. Connects users with licensed medical professionals.',
  ...
  },
  {
    ...
    brand: 'SpaceFix',
    tagline: 'Parking',
    description: 'Asset management category for parking space allocation and leasing. Integrates with LeeveitPH for secure space management.',
  ...
  },
  {
    ...
    icon: WaterDropIcon,
    brand: 'PoolFix',
    tagline: 'Pool Maintenance',
    description: 'Primary category for pool maintenance, repair, and chemical balancing services. Manages specialized aquatic facility vendors.',
    ...
    headerBgLight: '#2E5BA8',
    pillText: '#2E5BA8',
    services: ['Pool Cleaning', 'Pool Repair'],
    subServices: [
      {
        name: 'Pool Cleaning',
        description: 'Professional pool cleaning services that keep your pool sparkling, balanced, and ready to enjoy.',
        icon: SettingsIcon,
        image: '/images/sanifix.jpg'
      },
      {
        name: 'Pool Repair',
        description: 'Identifies and fixes water leaks in pool walls, plumbing, and equipment to prevent water loss and structural damage.',
        icon: HandymanIcon,
        image: '/images/sanifix.jpg'
      }
    ]
